...
export function LogDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!flex !flex-col !gap-0 !p-0 sm:!max-w-[90vw] !w-[1200px] !h-[80vh] overflow-hidden">
        {/* ── Fixed Header ── */}
        <DialogHeader className="px-6 pt-6 pb-4 shrink-0 border-b">
          <div className="flex items-center gap-3">
            <DialogTitle className="text-lg">Lead Capture Log</DialogTitle>
            {log && (
              <>
        ...
        {log ? (
          ...
          >
            ...
            {/* ── Scrollable Content Area (fixed height, never changes) ── */}
            <div className="flex-1 min-h-0">
                ...
                <ScrollArea className="h-full">
                  <div className="p-6 grid grid-cols-3 gap-4">
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        <Field
                          label="Tango Order ID"
                          value={log.tango_order_id}
                        />
                        <Field
                          label="Order Status"
                          value={log.tango_order_status}
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        <Field
                          label="Status"
                          value={log.persona_email_status}
                        />
                        <Field
                          label="Sent At"
                          value={log.persona_email_sent_at}
                        />
                        <Field
                          label="Message ID"
              ...
              >
                <ScrollArea className="h-full">
                  <pre className="p-6 text-xs font-mono leading-relaxed">
