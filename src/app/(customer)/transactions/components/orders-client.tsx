...
export function OrdersClient() {
  ...
  const [serverFilters, setServerFilters] = useState<{ custTransactionReference?: string }>({});
  ...
  // Handler for changing the selected transaction from within the dialog
  const handleTransactionChange = (newTransaction: Transaction) => {
  ...
  // Fetch transactions using React Query with server-side filters
  const { data, isLoading, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Add server-side filters to the query
      if (serverFilters.custTransactionReference) {
        params.append("cust_transaction_reference", serverFilters.custTransactionReference);
      }
  ...
  const handleServerSearch = (filters: { custTransactionReference?: string }) => {
